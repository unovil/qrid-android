...
class AuthenticationRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAllowedUserResult(allowedUser: AllowedUser): AuthenticationRepository.AllowedUserResult {
        ...
        return when (status) {
            -1 -> AuthenticationRepository.AllowedUserResult.Failure.NotFound
            0 -> AuthenticationRepository.AllowedUserResult.Failure.AlreadyRegistered
            null -> AuthenticationRepository.AllowedUserResult.Failure.Unknown
            else -> AuthenticationRepository.AllowedUserResult.Success(status, hashedPassword!!)
        }
    }
